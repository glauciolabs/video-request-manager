...
import { enforceFormIntakeAccess, issueFormAccessToken } from '../middlewares/form-access.js';
import { formAccessRateLimit } from '../middlewares/rate-limit.js';
...
router.post('/orders/intake/access', formAccessRateLimit, issueFormAccessToken);
router.post('/orders/intake', enforceFormIntakeAccess, (req, res) => proxyRequest(req, res, targets.orders, '/orders'));
...
router.delete('/orders/intake/:id', enforceAdminAccess, (req, res) => proxyRequest(req, res, targets.orders, '/orders'));
